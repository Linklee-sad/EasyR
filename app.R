...
ui <- fluidPage(
  ...
  language_switch_ui(),
  conditionalPanel("!output.workspace_ready", startup_ui("startup")),
  conditionalPanel("output.workspace_ready",
    tags$div(class = "easyr-app-header",
      tags$div(class = "easyr-brand-mark", icon("chart-simple")),
      tags$div(tags$div(class = "easyr-brand-title", "EasyR 数据工作台"),
        tags$div(class = "easyr-brand-subtitle", "导入 · 整理 · 探索 · 建模 · 预测 · 报告"))),
    ...
    tags$main(class = "easyr-main-panel",
      ...
      tags$div(class = "easyr-navigation",
        tabsetPanel(id = "main_navigation", selected = "data_workspace",
          ...
          tabPanel("统计与绘图", value = "analysis", tags$div(class = "workspace-page", analysis_ui("analysis"))),
          tabPanel("分布演示", value = "distributions", tags$div(class = "workspace-page", distribution_demo_ui("distributions"))),
          tabPanel("线性回归", value = "regression", tags$div(class = "workspace-page workspace-page-flat", regression_ui("regression"))),
          tabPanel("随机森林", value = "random_forest", tags$div(class = "workspace-page workspace-page-flat", random_forest_ui("random_forest"))),
          tabPanel("支持向量机", value = "svm", tags$div(class = "workspace-page workspace-page-flat", svm_ui("svm"))),
          tabPanel("主成分分析", value = "pca", tags$div(class = "workspace-page workspace-page-flat", pca_ui("pca"))),
          tabPanel("K-means 聚类", value = "kmeans", tags$div(class = "workspace-page workspace-page-flat", kmeans_ui("kmeans"))),
...
server <- function(input, output, session) {
  ...
  startup_server("startup", imported, project_channel, input, session, enter_workspace)
