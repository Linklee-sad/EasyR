...
1. 在开始界面选择 **创建新项目**、打开已有 `.easyr` 项目，或载入示例数据。
...
AI 功能支持 OpenAI、DeepSeek、通义千问（Qwen）和兼容第三方接口。用户只需要填写供应商、模型、API URL（第三方）和 API Key。
...
测试覆盖导入、项目恢复、清洗、空字段边界、10 类 ggplot2 图形、3D 绘图、图像导出、概率分布、AI 请求与脱敏、全部模型、交互教程、GARCH 和时间序列预测。
